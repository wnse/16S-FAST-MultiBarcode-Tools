...
def corresponding_seq2umi(adapter_info_file, primer_info_file, umi_dict):
    ...
    for k, v in type_seq.items():
        ...
        sta_list.append(['10 No. of A reads with adapter|linker({' + k + '})', v])
    ...
    sta_list.append(['11 No. of paired UMIs in A data', tmp1])
    sta_list.append(['12 No. of unpaired UMIs in A data', tmp2])
    sta_list.append(['13 No. of A seq of paired UMI', tmp3])
    sta_list.append(['14 No. of A seq of unpaired UMI', tmp4])
